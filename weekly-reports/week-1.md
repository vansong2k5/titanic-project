...
|-----------|------|-----------|----------------|
| Nguyễn Đoàn Văn Song|2351050153| EDA | ... |
...
|---------|------------|---|
| EDA | Đang làm  | 80% |
| Preprocessing + Pipeline | Đang làm | 10% |
| Modeling (≥3 models, wandb) | Chưa | 0% |
| Model Persistence | Chưa | 0% |
| Frontend (ReactJS) | Đang làm  | 10% |
...
|-----------|-------------------|
| Nguyễn Đoàn Văn Song | EDA + Processing + Pipeline|
| Nguyễn Thái Học | Fontend |
| Ngô Đình Dương|Fontend|
|Trịnh Gia Hào|Fontend|
